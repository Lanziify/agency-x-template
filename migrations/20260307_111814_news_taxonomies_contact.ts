...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "contacts_blocks_form_block" (
  ...
  ALTER TABLE "news" ADD CONSTRAINT "news_categories_id_categories_id_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_news_v" ADD CONSTRAINT "_news_v_version_categories_id_categories_id_fk" FOREIGN KEY ("version_categories_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "contacts_blocks_form_block" ADD CONSTRAINT "contacts_blocks_form_block_form_id_forms_id_fk" FOREIGN KEY ("form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "contacts_blocks_form_block" ADD CONSTRAINT "contacts_blocks_form_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."contacts"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "news_categories_idx" ON "news" USING btree ("categories_id");
  ...
  CREATE INDEX "_news_v_version_version_categories_idx" ON "_news_v" USING btree ("version_categories_id");
  ...
  CREATE INDEX "contacts_blocks_form_block_order_idx" ON "contacts_blocks_form_block" USING btree ("_order");
  CREATE INDEX "contacts_blocks_form_block_parent_id_idx" ON "contacts_blocks_form_block" USING btree ("_parent_id");
  CREATE INDEX "contacts_blocks_form_block_path_idx" ON "contacts_blocks_form_block" USING btree ("_path");
  CREATE INDEX "contacts_blocks_form_block_form_idx" ON "contacts_blocks_form_block" USING btree ("form_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "contacts_blocks_form_block" CASCADE;
